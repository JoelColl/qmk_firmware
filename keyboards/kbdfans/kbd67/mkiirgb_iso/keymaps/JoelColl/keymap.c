...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_iso_blocker(
        KC_ESC,  TD(TD_ONE_F1),    TD(TD_TWO_F2),    TD(TD_THREE_F3),    TD(TD_FOUR_F4),    TD(TD_FIVE_F5),    TD(TD_SIX_F6),    TD(TD_SEVEN_F7),    TD(TD_EIGHT_F8),    TD(TD_NINE_F9),    TD(TD_ZERO_F10), TD(TD_MINS_F11), TD(TD_EQUAL_F12),  KC_BSPC, KC_DEL,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,          KC_PGUP,
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSLS, KC_ENT,  KC_PGDN,
        KC_LSFT, TG(1), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PSCR,
